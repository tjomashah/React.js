...
class Holidays extends React.Component {
      ...
      createHolidaysPeriods(holidays = [], from, to) {
        ...
        this.getYearsUntil(from, to, function (year) {
          for (let i = 0; i < holidaysDates.length; i++) {
            ...
            // const item = [`"${holidays[monthDay]}";` + `"${year}-${monthDay}"`]; programm type
            data.push(item);
          }
        });
        console.log(data);
  ...
  parseJSon() {
    // const tableHeader = [["Festas nom;" + "Data"]]; programm type
    const tableHeader = [["Index", "Festas nom", "Data"]];
        ...
        >
          <thead>
            <tr>
              ...
              <th scope="col">Data</th> programm type */}
