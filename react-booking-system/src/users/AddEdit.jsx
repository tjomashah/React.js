    ...
    return (
        <div style={{padding: '80px 60px'}}>
            <form onSubmit={handleSubmit(onSubmit)} onReset={reset}>
                <h2 style={{paddingBottom: '20px'}}>{isAddMode ? 'Add Customer' : 'Edit Customer'}</h2>
                <div className="form-row">
                    <div className="form-group col">
                        <label>Title</label>
                        <select name="title" ref={register} className={`form-control ${errors.title 
                            ? 'is-invalid' : ''}`}>
                            <option value=""></option>
                ...
                <div className="form-row">
                    <div className="form-group col">
                        <label>
                            ...
                            {!isAddMode &&
                                (!showPassword
                                    ? <span> - <a onClick={() => setShowPassword(!showPassword)} 
                                    className="text-primary">Show</a></span>
                                    : <em> - {user.password}</em>
                                )
                            }
                        </label>
